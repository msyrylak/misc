...
#define _PRISizeT   "zX"
	...
	void DrawWindow(const char* title, u8* mem_data, size_t mem_size, std::map<uint16_t, uint16_t> changesMap, bool highlight, uint16_t highlightbyte, uint16_t pc, size_t base_display_addr = 0x0000)
    {
        Sizes s;
        ...
        if (ImGui::Begin(title, &Open, ImGuiWindowFlags_NoScrollbar))
        {
            ...
            DrawContents(mem_data, mem_size, changesMap, highlight, highlightbyte, pc, base_display_addr);
	...
	void DrawContents(u8* mem_data, size_t mem_size, std::map<uint16_t, uint16_t> changesMap, bool highlight, uint16_t highlightbyte, uint16_t pc, size_t base_display_addr = 0x0000);
